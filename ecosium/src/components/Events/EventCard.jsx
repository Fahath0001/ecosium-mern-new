...
const EventCard = (props) => {
    ...
    return (
        <>
            <div className='w-full min-w-[350px] lg:w-[calc(50%-10px)] xl:w-[calc(33%-15px)]  xxxl:w-[calc(25%-17px)] h-auto items-center justify-center flex flex-col p-[6px] bg-slate-100 relative'>
