...
import eventCategory from '../assets/eventCategory.js';
...
import mainData from '../assets/MainData.js';
import MainCategory from './Main/MainCategory.jsx';
import weddingCategory from '../assets/wedding/weddingCategory.js';


const CategorySlide = ({ type, hedding }) => {
  ...
  useEffect(() => {
    // Guard to check sliderRef.current exists before reading offsetHeight
    if (sliderRef.current) {
      // Sometimes wrapping in requestAnimationFrame or setTimeout helps
          ...
          >
            {
              categoryData.map((item, i) =>
                type === "main" ? (
                  <MainCategory item={item} key={i} height={sliderHeight} />
